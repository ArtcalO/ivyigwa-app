		...
		<div class="container-login100" style="background-image: url('static/login/images/bg-01.jpg');">
			<div class="wrap-login100">
				<form class="login100-form validate-form">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "PDF">
						<input class="input100" type="file" name="avatar" placeholder="pdf">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
                    <div class="wrap-input100 validate-input" data-validate = "Price">
						<input class="input100" type="text" name="first_name" placeholder="Price">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
                    <div class="wrap-input100 validate-input" data-validate = "Release date">
						<input class="input100" type="date" name="first_name" placeholder="Release">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
