<%@ Page Language="C#" AutoEventWireup="true" CodeFile="my_courses.aspx.cs" Inherits="my_courses" %>
<!DOCTYPE html>
                    ...
                    <div class="d-flex align-items-center"><img class="img-fluid" src="static/assets/img/gallery/watch-2.png" height="200" width="200" alt="testimonials" />
                      <div class="flex-1 ms-4">
                        ...
                        <div class="col-4 col-lg-3">
                          <button class="btn btn-primary rounded-start-0" type="button">Start Course / Poursue</button>
                        </div>
                      </div>
                    </div>
                  </div>
